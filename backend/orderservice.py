...
# Config Odoo
url = "https://solienlacdientu.info/jsonrpc"   # URL server Odoo
db = "goldsun"                          # tên database
username = "admin"                      # user đăng nhập
password = "admin"                      # mật khẩu
DEPOSIT_PAYMENT_TERM_ID = 1
# 1. Authenticate
...
def get_or_create_product(product_name, price_unit, company_id):
    ...
    if products:
        ...
        product_data = {
            ...
            "type": "service",     # hoặc "service" nếu là dịch vụ
            "sale_ok": True,     # cho phép bán
            "purchase_ok": False, # cho phép mua
...
def create_service_order_from_json(data):
    ...
    order_data = {
        ...
        "payment_term_id": DEPOSIT_PAYMENT_TERM_ID,  # Điều khoản thanh toán (nếu có)
    }
    ...
    print("Đơn đặt cọc và các dòng sản phẩm đã được tạo thành công!")

data =  {"id": 1, 
         "displayName": "An Phương Loan", 
         "phone": "*0819322222", "email": None, 
         "street": "51 nguyễn công trứ , đồng nhân , hai bà trưng , hà nội", 
         "city": None, "stateId": 0, "vat": None, "cccdNumber": None, 
         "cccdVerified": 0, "customerType": "CustomerType.newCustomer", 
         "orderitems": [{"id": 25, "server_id": 0, 
                         "order_id": 23, "product_id": 1, 
                         "name": "Hà", "sequence": 1, 
                         "quantity": 8, "price_unit": 1000000.0, 
                         "discount": 0.0, "tax_ids": 1, 
                         "total_price_without_tax": 5400000.0, 
                         "total_price_with_tax": 8000000.0, 
                         "is_reward": 0, "is_gift": 0, 
                         "gift_group_id": 0, "return_reason": None, 
                         "original_brand": None, "ham_luong": 0.0, 
                         "trong_luong_da": 0.0, "tien_cong_ban": 0.0, 
                         "tien_da": 0.0, "is_exchange_return": 0, 
                         "exchange_from_order_item_id": None, 
                         "service_id": 0, "item_type": "product", 
                         "status": "pending", "weight_grams": 0.0, 
                         "material": "other", "carat": 0.0, 
                         "condition": "new", 
                         "product_sku": "SRV-001", 
                         "appraisal_photo_path": None, 
                         "created_at": "2025-11-24T08:13:21.809105", 
                         "updated_at": "2025-11-24T09:00:29.609628", 
                         "deleted_at": None, "deleted_by": 0, "is_synced": 0,
                           "last_sync_at": None}, 
                           {"id": 29, "server_id": 0, "order_id": 23, "product_id": 7, 
                            "name": "Nhẫn tròn ép vỉ Kim Gia Bảo, loại 1 chỉ - 24K (999.9)", 
                            "sequence": 2, "quantity": 7, "price_unit": 1000000.0, 
                            "discount": 0.0, "tax_ids": 1, "total_price_without_tax": 6300000.0, 
                            "total_price_with_tax": 7000000.0, "is_reward": 0, "is_gift": 0, 
                            "gift_group_id": 0, "return_reason": None, "original_brand": None, 
                            "ham_luong": 0.0, "trong_luong_da": 0.0, "tien_cong_ban": 0.0, "tien_da": 0.0, "is_exchange_return": 0, "exchange_from_order_item_id": None, "service_id": 0, "item_type": "product", "status": "pending", "weight_grams": 0.0, "material": "other", "carat": 0.0, "condition": "new", "product_sku": "SERV-002", "appraisal_photo_path": None, "created_at": "2025-11-24T08:59:49.860981", "updated_at": "2025-11-24T08:59:49.860981", "deleted_at": None, "deleted_by": 0, "is_synced": 0, "last_sync_at": None}, {id: 30, "server_id": 0, "order_id": 23, "product_id": 4, "name": "Xi", "sequence": 3, "quantity": 10, "price_unit": 1000000.0, "discount": 0.0, "tax_ids": 1, "total_price_without_tax": 9000000.0, "total_price_with_tax": 10000000.0, "is_reward": 0, "is_gift": 0, "gift_group_id": 0, "return_reason": None, "original_brand": None, "ham_luong": 0.0, "trong_luong_da": 0.0, "tien_cong_ban": 0.0, "tien_da": 0.0, "is_exchange_return": 0, "exchange_from_order_item_id": None, "service_id": 0, "item_type": "product", "status": "pending", "weight_grams": 0.0, "material": "other", "carat": 0.0, "condition": "new", "product_sku": "SRV-003", "appraisal_photo_path": None, "created_at": "2025-11-24T09:00:23.998840", "updated_at": "2025-11-24T09:00:23.998840", "deleted_at": None, "deleted_by": 0, "is_synced": 0, "last_sync_at": None}, 
                            {id: 31, "server_id": 0, "order_id": 23, "product_id": 2, "name": "Nhẫn ép vỉ Vàng Rồng Thăng Long, 2 chỉ - 24K (999.9)", "sequence": 4, "quantity": 9, "price_unit": 1000000.0, "discount": 0.0, "tax_ids": 1, "total_price_without_tax": 8100000.0, "total_price_with_tax": 9000000.0, "is_reward": 0, "is_gift": 0, "gift_group_id": 0, "return_reason": None, "original_brand": None, "ham_luong": 0.0, "trong_luong_da": 0.0, "tien_cong_ban": 0.0, "tien_da": 0.0, "is_exchange_return": 0, "exchange_from_order_item_id": None, "service_id": 0, "item_type": "product", "status": "pending", "weight_grams": 0.0, "material": "other", "carat": 0.0, "condition": "new", "product_sku": "SRV-004", "appraisal_photo_path": None, "created_at": "2025-11-24T10:56:29.219156", "updated_at": "2025-11-24T10:56:29.219156", "deleted_at": None, "deleted_by": 0, "is_synced": 0, "last_sync_at": None}, 
                            {"id": 32, "server_id": 0, "order_id": 23, "product_id": 19, "name": "Vệ sinh", "sequence": 5, "quantity": 7, "price_unit": 1000000.0, "discount": 0.0, "tax_ids": 1, "total_price_without_tax": 6300000.0, "total_price_with_tax": 7000000.0, "is_reward": 0, "is_gift": 0, "gift_group_id": 0, "return_reason": None, "original_brand": None, "ham_luong": 0.0, "trong_luong_da": 0.0, "tien_cong_ban": 0.0, "tien_da": 0.0, "is_exchange_return": 0, "exchange_from_order_item_id": None, "service_id": 0, "item_type": "product", "status": "pending", "weight_grams": 0.0, "material": "other", "carat": 0.0, "condition": "new", "product_sku": "SRV-005", "appraisal_photo_path": None, "created_at": "2025-11-24T10:56:45.445515", "updated_at": "2025-11-24T10:56:45.445515", "deleted_at": None, "deleted_by": 0, "is_synced": 0, "last_sync_at": None}]}

create_service_order_from_json(data)